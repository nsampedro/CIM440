...
var sloth, puppy, dinosaur, lion, orca;

var sButton, pButton, dButton, lButton, oButton;
...
function preload(){
  ...
  orca = loadImage("images/orca.jpg")
}
...
if(currentImage == 0){
  ...
  image(orca,0,0,orca.width/4,orca.height/4);
}
